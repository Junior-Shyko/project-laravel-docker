                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group">
                                   ...
                                   <input id="fullName" name="fullName" v-model="user.name" placeholder="Full Name" class="form-control" required="true" value="" type="text"></div>
                            </div>
                         </div>
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               ...
                               <input id="addressLine1" name="addressLine1" v-model="user.user_address" placeholder="Address Line 1" class="form-control" required="true" value="" type="text"></div>
                            </div>
                         </div>
                         <div class="form-group">
                      ...
                      <fieldset>
                         <div class="form-group">
                            ...
                            <div class="col-md-8 inputGroupContainer">
                               ...
                               <input id="fullName" name="fullName" v-model="user.email" placeholder="Full Name" class="form-control" required="true" value="" type="text"></div>
                            </div>
                         </div>
                         <div class="form-group">
                            <label class="col-md-4 control-label">Address Line 1</label>
...
export default {
    ...
    mounted() {
        ...
        this.idUser = currentUrl.substr(-6,1);

        axios.get(domain_complet+'user/'+this.idUser)
            .then(response => (
